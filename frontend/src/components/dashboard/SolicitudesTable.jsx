// src/components/dashboard/SolicitudesTable_enhanced.jsx - VERSIÓN MEJORADA COMPLETA
 ...
 */
const SolicitudesTableEnhanced = ({
  solicitudes = [],
  isLoading = false,
  onEdit = () => {},
  onView = () => {},
    ...
    <div className={cn('table-container', className)} {...props}>
      ...
      <div className="overflow-x-auto">
        <table className="solicitudes-table">
          <thead>
            <tr>
              <SortableHeader sortKey="nombre_descriptivo">
                Nombre Descriptivo
              </SortableHeader>
              <th className="hidden lg:table-cell">Tipo de Búsqueda</th>
              <SortableHeader sortKey="frecuencia" className="hidden md:table-cell">
                <div className="flex items-center gap-2">
                  <Calendar className="w-4 h-4" />
                  Frecuencia
                </div>
              </SortableHeader>
              <SortableHeader sortKey="estado">
                Estado
              </SortableHeader>
              <SortableHeader sortKey="ultima_ejecucion" className="hidden lg:table-cell">
                <div className="flex items-center gap-2">
...
SolicitudesTableEnhanced.displayName = 'SolicitudesTableEnhanced'

export default SolicitudesTableEnhanced